...
func CreatedAtIsNil() predicate.Collection {
	return predicate.Collection(sql.FieldIsNull(FieldCreatedAt))
}

// CreatedAtNotNil applies the NotNil predicate on the "created_at" field.
func CreatedAtNotNil() predicate.Collection {
	return predicate.Collection(sql.FieldNotNull(FieldCreatedAt))
}
...
func UpdatedAtIsNil() predicate.Collection {
	return predicate.Collection(sql.FieldIsNull(FieldUpdatedAt))
}

// UpdatedAtNotNil applies the NotNil predicate on the "updated_at" field.
func UpdatedAtNotNil() predicate.Collection {
	return predicate.Collection(sql.FieldNotNull(FieldUpdatedAt))
}

// HasProfile applies the HasEdge predicate on the "profile" edge.
func HasProfile() predicate.Collection {
...
func HasProfileWith(preds ...predicate.Profile) predicate.Collection {
	return predicate.Collection(func(s *sql.Selector) {
		step := newProfileStep()
...
func HasItems() predicate.Collection {
	return predicate.Collection(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasItemsWith(preds ...predicate.CollectionItem) predicate.Collection {
	return predicate.Collection(func(s *sql.Selector) {
		step := newItemsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
