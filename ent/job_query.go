...
func (_q *JobQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *JobQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *JobQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *JobQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *JobQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *JobQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
