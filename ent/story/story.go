...
const (
	...
	ViewsTable = "story_views"
	// ViewsInverseTable is the table name for the StoryView entity.
	// It exists in this package in order to avoid circular dependency with the "storyview" package.
	ViewsInverseTable = "story_views"
	// ViewsColumn is the table column denoting the views relation/edge.
	ViewsColumn = "story_id"
)
