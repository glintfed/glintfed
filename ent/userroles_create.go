...
func (_c *UserRolesCreate) SetNillableRoles(v *string) *UserRolesCreate {
	if v != nil {
		_c.SetRoles(*v)
	}
	return _c
...
func (_c *UserRolesCreate) SetMeta(v string) *UserRolesCreate {
	_c.mutation.SetMeta(v)
	return _c
}

// SetNillableMeta sets the "meta" field if the given value is not nil.
func (_c *UserRolesCreate) SetNillableMeta(v *string) *UserRolesCreate {
	if v != nil {
		_c.SetMeta(*v)
	}
	return _c
...
func (_c *UserRolesCreate) SetUser(v *User) *UserRolesCreate {
