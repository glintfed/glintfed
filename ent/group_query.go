...
func (_q *GroupQuery) QueryAdmin() *ProfileQuery {
...
func (_q *GroupQuery) WithAdmin(opts ...func(*ProfileQuery)) *GroupQuery {
	query := (&ProfileClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *GroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Group, error) {
	...
	if query := _q.withAdmin; query != nil {
		if err := _q.loadAdmin(ctx, query, nodes, nil,
			func(n *Group, e *Profile) { n.Edges.Admin = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *GroupQuery) loadAdmin(ctx context.Context, query *ProfileQuery, nodes []*Group, init func(*Group), assign func(*Group, *Profile)) error {
...
func (_q *GroupQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAdmin != nil {
			_spec.Node.AddColumnOnce(group.FieldProfileID)
		}
	}
