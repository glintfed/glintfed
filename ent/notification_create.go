...
func (_c *NotificationCreate) SetActor(v *Profile) *NotificationCreate {
	return _c.SetActorID(v.ID)
}

// SetProfile sets the "profile" edge to the Profile entity.
func (_c *NotificationCreate) SetProfile(v *Profile) *NotificationCreate {
	return _c.SetProfileID(v.ID)
}

// SetStatusID sets the "status" edge to the Status entity by ID.
func (_c *NotificationCreate) SetStatusID(id uint64) *NotificationCreate {
...
func (_c *NotificationCreate) SetNillableStatusID(id *uint64) *NotificationCreate {
	if id != nil {
...
func (_c *NotificationCreate) SetStatus(v *Status) *NotificationCreate {
