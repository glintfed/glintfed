...
func (_q *MediaQuery) QueryStatus() *StatusQuery {
...
func (_q *MediaQuery) QueryProfile() *ProfileQuery {
...
func (_q *MediaQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *MediaQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *MediaQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *MediaQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *MediaQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *MediaQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MediaQuery) WithStatus(opts ...func(*StatusQuery)) *MediaQuery {
	query := (&StatusClient{config: _q.config}).Query()
...
func (_q *MediaQuery) WithProfile(opts ...func(*ProfileQuery)) *MediaQuery {
	query := (&ProfileClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MediaQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Media, error) {
	...
	if query := _q.withStatus; query != nil {
		if err := _q.loadStatus(ctx, query, nodes, nil,
			func(n *Media, e *Status) { n.Edges.Status = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withProfile; query != nil {
		if err := _q.loadProfile(ctx, query, nodes, nil,
			func(n *Media, e *Profile) { n.Edges.Profile = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MediaQuery) loadStatus(ctx context.Context, query *StatusQuery, nodes []*Media, init func(*Media), assign func(*Media, *Status)) error {
	ids := make([]uint64, 0, len(nodes))
	nodeids := make(map[uint64][]*Media)
	for i := range nodes {
...
func (_q *MediaQuery) loadProfile(ctx context.Context, query *ProfileQuery, nodes []*Media, init func(*Media), assign func(*Media, *Profile)) error {
	ids := make([]uint64, 0, len(nodes))
	nodeids := make(map[uint64][]*Media)
	for i := range nodes {
...
func (_q *MediaQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(media.Table, media.Columns, sqlgraph.NewFieldSpec(media.FieldID, field.TypeUint))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withStatus != nil {
			_spec.Node.AddColumnOnce(media.FieldStatusID)
		}
		if _q.withProfile != nil {
			_spec.Node.AddColumnOnce(media.FieldProfileID)
		}
	}
