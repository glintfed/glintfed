...
func Expiration(v int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldEQ(FieldExpiration, v))
}
...
func ExpirationEQ(v int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldEQ(FieldExpiration, v))
}

// ExpirationNEQ applies the NEQ predicate on the "expiration" field.
func ExpirationNEQ(v int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldNEQ(FieldExpiration, v))
}

// ExpirationIn applies the In predicate on the "expiration" field.
func ExpirationIn(vs ...int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldIn(FieldExpiration, vs...))
}

// ExpirationNotIn applies the NotIn predicate on the "expiration" field.
func ExpirationNotIn(vs ...int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldNotIn(FieldExpiration, vs...))
}

// ExpirationGT applies the GT predicate on the "expiration" field.
func ExpirationGT(v int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldGT(FieldExpiration, v))
}

// ExpirationGTE applies the GTE predicate on the "expiration" field.
func ExpirationGTE(v int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldGTE(FieldExpiration, v))
}

// ExpirationLT applies the LT predicate on the "expiration" field.
func ExpirationLT(v int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldLT(FieldExpiration, v))
}

// ExpirationLTE applies the LTE predicate on the "expiration" field.
func ExpirationLTE(v int) predicate.CacheLock {
	return predicate.CacheLock(sql.FieldLTE(FieldExpiration, v))
}
