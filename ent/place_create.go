...
func (_c *PlaceCreate) SetAliases(v string) *PlaceCreate {
	_c.mutation.SetAliases(v)
	return _c
}

// SetNillableAliases sets the "aliases" field if the given value is not nil.
func (_c *PlaceCreate) SetNillableAliases(v *string) *PlaceCreate {
	if v != nil {
		_c.SetAliases(*v)
	}
	return _c
...
func (_c *PlaceCreate) SetScore(v int) *PlaceCreate {
...
func (_c *PlaceCreate) AddPostIDs(ids ...uint64) *PlaceCreate {
	_c.mutation.AddPostIDs(ids...)
	return _c
}

// AddPosts adds the "posts" edges to the Status entity.
func (_c *PlaceCreate) AddPosts(v ...*Status) *PlaceCreate {
...
func (_c *PlaceCreate) AddStatusIDs(ids ...uint64) *PlaceCreate {
	_c.mutation.AddStatusIDs(ids...)
	return _c
}

// AddStatuses adds the "statuses" edges to the Status entity.
func (_c *PlaceCreate) AddStatuses(v ...*Status) *PlaceCreate {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
