...
type Mention struct {
	...
	// The values are being populated by the MentionQuery when eager-loading is set.
	Edges        MentionEdges `json:"edges"`
	selectValues sql.SelectValues
}

// MentionEdges holds the relations/edges for other nodes in the graph.
type MentionEdges struct {
...
func (e MentionEdges) ProfileOrErr() (*Profile, error) {
	if e.Profile != nil {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e MentionEdges) StatusOrErr() (*Status, error) {
	if e.Status != nil {
		return e.Status, nil
...
// QueryProfile queries the "profile" edge of the Mention entity.
func (_m *Mention) QueryProfile() *ProfileQuery {
	return NewMentionClient(_m.config).QueryProfile(_m)
}

// QueryStatus queries the "status" edge of the Mention entity.
func (_m *Mention) QueryStatus() *StatusQuery {
	return NewMentionClient(_m.config).QueryStatus(_m)
}
