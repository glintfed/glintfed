...
func CategoryID(v uint) predicate.Group {
...
func Metadata(v string) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldMetadata, v))
}
...
func MemberCount(v uint) predicate.Group {
...
func MetadataEQ(v string) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldMetadata, v))
}

// MetadataNEQ applies the NEQ predicate on the "metadata" field.
func MetadataNEQ(v string) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldMetadata, v))
}

// MetadataIn applies the In predicate on the "metadata" field.
func MetadataIn(vs ...string) predicate.Group {
	return predicate.Group(sql.FieldIn(FieldMetadata, vs...))
}

// MetadataNotIn applies the NotIn predicate on the "metadata" field.
func MetadataNotIn(vs ...string) predicate.Group {
	return predicate.Group(sql.FieldNotIn(FieldMetadata, vs...))
}

// MetadataGT applies the GT predicate on the "metadata" field.
func MetadataGT(v string) predicate.Group {
	return predicate.Group(sql.FieldGT(FieldMetadata, v))
}

// MetadataGTE applies the GTE predicate on the "metadata" field.
func MetadataGTE(v string) predicate.Group {
	return predicate.Group(sql.FieldGTE(FieldMetadata, v))
}

// MetadataLT applies the LT predicate on the "metadata" field.
func MetadataLT(v string) predicate.Group {
	return predicate.Group(sql.FieldLT(FieldMetadata, v))
}

// MetadataLTE applies the LTE predicate on the "metadata" field.
func MetadataLTE(v string) predicate.Group {
	return predicate.Group(sql.FieldLTE(FieldMetadata, v))
}

// MetadataContains applies the Contains predicate on the "metadata" field.
func MetadataContains(v string) predicate.Group {
	return predicate.Group(sql.FieldContains(FieldMetadata, v))
}

// MetadataHasPrefix applies the HasPrefix predicate on the "metadata" field.
func MetadataHasPrefix(v string) predicate.Group {
	return predicate.Group(sql.FieldHasPrefix(FieldMetadata, v))
}

// MetadataHasSuffix applies the HasSuffix predicate on the "metadata" field.
func MetadataHasSuffix(v string) predicate.Group {
	return predicate.Group(sql.FieldHasSuffix(FieldMetadata, v))
}
...
func MetadataEqualFold(v string) predicate.Group {
	return predicate.Group(sql.FieldEqualFold(FieldMetadata, v))
}

// MetadataContainsFold applies the ContainsFold predicate on the "metadata" field.
func MetadataContainsFold(v string) predicate.Group {
	return predicate.Group(sql.FieldContainsFold(FieldMetadata, v))
}
...
func MemberCountNotIn(vs ...uint) predicate.Group {
...
func HasAdminWith(preds ...predicate.Profile) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := newAdminStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
